const SECTS ={
    ...
    title:'禅武合一 · 天下第一大派',
    emblem:'☸',
    tagtag:""   desc:'坐desc:""otto:'武以载道，止戈为武',
    ...
    members:'三千僧兵',
    relations:{
      allies:  ['wudang','huashan','emei','kongtong',members:""gguang','nangong'],  // 正道同盟
  ...
  }
{
    ...
    title:'道法自然 · 以柔克刚',
    emblem:'☯',
    tagtag:""   desc:'坐desc:""otto:'道可道，非常道',
    ...
    members:'七侠五义',
    relations:{
      allies:  ['shaolin','huashan','emeimembers:""kunlun','tianshan','shengguang'],
  ...
  }
{
    ...
    title:'华山论剑 · 剑道极致',
    emblem:'⚔',
    tagtag:""   desc:'华desc:""otto:'剑走偏锋，以快制胜',
    ...
    members:'华山五老',
    relations:{
      allies:  ['shaolin','wudang','emei','kunlumembers:""
  ...
  }
{
    ...
    title:'明尊光明 · 圣火燃天',
    emblem:'🔥',
    tatag:""    desc:desc:"" motto:'焚我残躯，熊熊圣火',
    ...
    members:'四法王三使者',
    relations:{
      allies:  ['tiandibang','tianlong'],  members:""              // 混乱同路人
  ...
  }
{
    ...
    title:'五毒共生 · 百毒不侵',
    emblem:'🐍',
    tagtag:""   desc:'深desc:""otto:'以毒攻毒，百毒不侵',
    ...
    members:'五毒童子',
    relations:{
      allies:  ['xuanming','xuegu'],            members:""// 邪道同盟
  ...
  }
{
    ...
    title:'暗器天下第一 · 百步穿杨',
    emblem:'🏹',
    tatag:""    desc:'desc:""motto:'百步穿杨，一击毙命',
    ...
    members:'唐门三老',
    relations:{
      allies:  ['guigu','lingxiao'],            members:"" 同为情报/技术流
  ...
  }
{
    ...
    title:'聪颖无双 · 奇门异术',
    emblem:'🌸',
    tagtag:""   desc:'东desc:""otto:'移花接木，无中生有',
    ...
    members:'黄老邪门下',
    relations:{
      allies:  ['xiaoyao','lingxiao'],            members:""飘逸自在派
  ...
  }
{
    ...
    title:'逍遥天地 · 无拘无束',
    emblem:'🌀',
    tagtag:""   desc:'逍desc:""otto:'逍遥天地，自在人间',
    ...
    members:'三位传人',
    relations:{
      allies:  ['taohuadao','guigu'],            members:""同为奇学派
  ...
  }
{
    ...
    title:'雷霆万钧 · 霸道天下',
    emblem:'⚡',
    tagtag:""   desc:'江desc:""otto:'雷霆所至，无不臣服',
    ...
    members:'千余帮众',
    relations:{
      allies:  ['mingjiao','tianlong','haismembers:""   // 混乱势力联盟
  ...
  }
{
    ...
    title:'算无遗策 · 运筹帷幄',
    emblem:'🔮',
    tagtag:""   desc:'神秘desc:""tto:'运筹帷幄，决胜千里',
    schools:['qimen','fate','shadow'],
    color:'#d4b050', colmotto:""  glow:'rgba(212,176,80,.28)', border:'rgba(212,176,80,.18)',
    bg1:'rgba(212,176,80,.05)', bg2:'rgba(212,176,80,.02)',
    tier:'minor',
    alignment:'neutral',
    members:'寥寥数人',
    relations:{
      allies:  ['lingxiao','tangmen','xiaoyao'],           members:""     rivals:  ['riyue','xuanming'],                        // 被邪道忌惮
      enemies: [],                                           // 从不主动结仇
    },
  ...
  }
{
    ...
    title:'光明正道 · 圣裁天下',
    emblem:'✦',
    tagtag:""   desc:'以desc:""otto:'圣光普照，邪不胜正',
    ...
    members:'圣骑士团',
    relations:{
      allies:  ['shaolin','wudang','emei','tiansmembers:"" 正道联盟
  ...
  }
{
    ...
    title:'女中豪杰 · 圣洁峰巅',
    emblem:'🌺',
    tagtag:""   desc:'峨desc:""otto:'清心寡欲，峨眉天下',
    schools:['holy','ice','tao'],
    color:'#ffaad4', color2motto:""low:'rgba(255,170,212,.28)', border:'rgba(255,170,212,.18)',
    bg1:'rgba(255,170,212,.05)', bg2:'rgba(255,170,212,.02)',
    tier:'major',
    alignment:'righteous',
    members:'百余女弟子',
    relations:{
      allies:  ['shaolin','wudang','kunlun','tianshan','members:""     rivals:  ['tiandibang','mingjiao'],
  ...
  }
{
    ...
    title:'七伤绝技 · 北地武宗',
    emblem:'🌪',
    tagtag:""   desc:'坐desc:""otto:'伤我七分，换你十分',
    ...
    members:'崆峒五老',
    relations:{
      allies:  ['shaolin','wudang','kunlun','nangomembers:""vals:  ['tianlong','tiandibang'],                   // 北方势力摩擦
  ...
  }
{
    ...
    title:'雪域高原 · 金刚剑法',
    emblem:'🏔',
    tagtag:""   desc:'昆desc:""otto:'高山仰止，景行行止',
    ...
    members:'昆仑三圣',
    relations:{
      allies:  ['shaolin','wudang','huashan','tiamembers:"" rivals:  ['xixia','diancang'],                        // 西域/西南路线之争
  ...
  }
{
    ...
    title:'云贵秘境 · 苍山剑法',
    emblem:'💠',
    tagtag:""   desc:'云desc:""otto:'苍山如海，残阳如血',
    ...
    members:'苍派三老',
    relations:{
      allies:  ['tangmen','qingcheng'],         members:"" 同为南路毒剑派
  ...
  }
{
    ...
    title:'天山雪莲 · 冰封绝技',
    emblem:'❄',
    tagtag:""   desc:'天山desc:""tto:'冰心玉壶，天下无双',
    schools:['ice','tao','holy'],
    color:'#d0f0ff', colmotto:""  glow:'rgba(208,240,255,.25)', border:'rgba(208,240,255,.15)',
 ...
 members:""['xixia','xiaoyao'],                         // 西域/逍遥路线竞争
  ...
  }
{
    ...
    title:'西域绝学 · 神秘莫测',
    emblem:'🌙',
    tag:tag:""  desc:'来自desc:""tto:'天命所归，顺势而为',
    schools:['fate','qimen','shadow'],
    color:'#c0a0e0', cmotto:""    glow:'rgba(192,160,224,.28)', border:'rgba(192,160,224,.18)',
    bg1:'rgba(192,160,224,.05)', bg2:'rgba(192,160,224,.02)',
    tier:'minor',
    alignment:'neutral',
    members:'密宗三法王',
    relations:{
      allies:  ['guigu','diancang'],                    members:""
  ...
  }
{
    ...
    title:'龙象并进 · 天下无敌',
    emblem:'🐉',
    tagtag:""   desc:'源自desc:""tto:'龙腾四海，象步千山',
    schools:['force','fist','buddha'],
    color:'#e8a000', colmotto:""  glow:'rgba(232,160,0,.32)', border:'rgba(232,160,0,.2)',
    bg1:'rgba(232,160,0,.06)', bg2:'rgba(232,160,0,.02)',
    tier:'minor',
    alignment:'chaotic',
    members:'龙象十八罗汉',
    relations:{
      allies:  ['tiandibang','haisha'],                  members:""   rivals:  ['mingjiao','kongtong'],                     // 势力地盘争夺
  ...
  }
{
    ...
    title:'世家贵族 · 剑道风雅',
    emblem:'🏛',
    tag:tag:""  desc:'中原desc:""tto:'礼义廉耻，剑道之魂',
    ...
    members:'南宫家族',
    relations:{
      allies:  ['shaolin','wudang','huashan','shengguanmembers:""als:  ['tiandibang','haisha'],                     // 瞧不起草莽帮派
  ...
  }
{
    ...
    title:'阴冷霸道 · 玄冥二老',
    emblem:'⛧',
    tagtag:""   desc:'以desc:""otto:'玄冥寒掌，天下无解',
    ...
    members:'玄冥二老',
    relations:{
      allies:  ['riyue','wudu','xuegu'],               members:""     rivals:  ['mingjiao','tianlong'],                     // 势力摩擦
  ...
  }
{
    ...
    title:'东海霸主 · 刀法无双',
    emblem:'⚓',
    tagtag:""   desc:'盘踞desc:""tto:'七杀刀出，血染东海',
    ...
    members:'三千海贼',
    relations:{
      allies:  ['tiandibang','tianlong'],             members:""路人
  ...
  }
{
    ...
    title:'日月当空 · 教主独尊',
    emblem:'☀',
    tag:tag:""  desc:'教主desc:""tto:'千秋万载，一统江湖',
    schools:['fire','ice','fate'],
    color:'#ff8800', colomotto:"" glow:'rgba(255,136,0,.35)', border:'rgba(255,136,0,.2)',
    bg1:'rgba(255,136,0,.06)', bg2:'rgba(255,136,0,.02)',
    tier:'supreme',
    alignment:'evil',
    members:'教众十万',
    relations:{
      allies:  ['xuanming','wudu','xuegu'],             members:""      rivals:  ['mingjiao','tianlong'],                     // 争夺江湖霸权
  ...
  }
{
    ...
    title:'以血炼功 · 杀伐决断',
    emblem:'💀',
    tagtag:""   desc:'以desc:""otto:'血祭苍天，骨铸神兵',
    schools:['fist','force','dark'],
    color:'#cc2020', cmotto:""    glow:'rgba(204,32,32,.35)', border:'rgba(204,32,32,.22)',
    bg1:'rgba(204,32,32,.07)', bg2:'rgba(204,32,32,.03)',
    tier:'minor',
    alignment:'evil',
    members:'百名血骨士',
    relations:{
      allies:  ['riyue','xuanming'],                  members:""     rivals:  ['wudu'],                                    // 邪道内部竞争
  ...
  }
{
    ...
    title:'凌云之志 · 天下第一楼',
    emblem:'🏯',
    tagtag:""   desc:'中desc:""otto:'消息通天下，剑指凌霄阁',
    ...
    members:'三十六名阁主',
    relations:{
      allies:  ['tangmen','guigu','taohuadao'],      members:""
