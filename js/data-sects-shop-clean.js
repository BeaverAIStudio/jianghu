...
const SECT_CONTRIB_SHOP = {
  ...
  shaolin: {
    items: [
      { id:'cs_s_frag',   icon:'📜', name:"",       desc:"",  cost:30,  type:'manual', manualId:'m_bd_partial1',   reqLv:15 },
      { id:'cs_s_compl',  icon:'📖', name:"",        desc:"",           cost:80,  type:'manual', manualId:'m_bd_complete1',  reqLv:28 },
      { id:'cs_s_med',    icon:'💊', name:"",            desc:"",           cost:25,  type:'consumable' },
      { id:'cs_s_title',  icon:'🏅', name:"",      desc:"",       cost:15,  type:'title' },
    ]
  },
  // ── 武当派 ──
  wudang: {
    items: [
      { id:'cs_w_frag',   icon:'📜', name:"",      desc:"",            cost:30,  type:'manual', manualId:'m_ta_partial1',   reqLv:14 },
      { id:'cs_w_compl',  icon:'📖', name:"",       desc:"",            cost:80,  type:'manual', manualId:'m_ta_complete1',  reqLv:26 },
      { id:'cs_w_med',    icon:'💊', name:"",         desc:"",                 cost:25,  type:'consumable' },
      { id:'cs_w_title',  icon:'🏅', name:"",       desc:"",                        cost:15,  type:'title' },
    ]
  },
  // ── 华山派 ──
  huashan: {
    items: [
      { id:'cs_h_frag',   icon:'📜', name:"",      desc:"",          cost:30,  type:'manual', manualId:'m_sw_partial1',   reqLv:12 },
      { id:'cs_h_compl',  icon:'📖', name:"",      desc:"",                cost:80,  type:'manual', manualId:'m_sw_complete1',  reqLv:25 },
      { id:'cs_h_med',    icon:'💊', name:"",         desc:"",                   cost:25,  type:'consumable' },
      { id:'cs_h_title',  icon:'🏅', name:"",       desc:"",                         cost:15,  type:'title' },
    ]
  },
  // ── 明教 ──
  mingjiao: {
    items: [
      { id:'cs_m_frag',   icon:'📜', name:"",      desc:"",                cost:30,  type:'manual', manualId:'m_fi_partial1',   reqLv:15 },
      { id:'cs_m_compl',  icon:'📖', name:"",    desc:"",                    cost:80,  type:'manual', manualId:'m_fi_complete1',  reqLv:26 },
      { id:'cs_m_med',    icon:'💊', name:"",             desc:"",       cost:25,  type:'consumable' },
      { id:'cs_m_title',  icon:'🏅', name:"",        desc:"",                           cost:15,  type:'title' },
    ]
  },
  // ── 逍遥派 ──
  xiaoyao: {
    items: [
      { id:'cs_x_frag',   icon:'📜', name:"",      desc:"",                           cost:30,  type:'manual', manualId:'m_ic_partial1',   reqLv:16 },
      { id:'cs_x_med',    icon:'💊', name:"",           desc:"",                   cost:25,  type:'consumable' },
      { id:'cs_x_title',  icon:'🏅', name:"",      desc:"",                         cost:15,  type:'title' },
    ]
  },
  // ── 崆峒派 ──
  kongtong: {
    items: [
      { id:'cs_k_frag',   icon:'📜', name:"",        desc:"",                cost:30,  type:'manual', manualId:'m_th_partial1',   reqLv:16 },
      { id:'cs_k_med',    icon:'💊', name:"",           desc:"",               cost:25,  type:'consumable' },
      { id:'cs_k_title',  icon:'🏅', name:"",      desc:"",                         cost:15,  type:'title' },
    ]
  },
  // ── 昆仑派 ──
  kunlun: {
    items: [
      { id:'cs_ku_frag',  icon:'📜', name:"",      desc:"",                         cost:30,  type:'manual', manualId:'m_sw_partial1',   reqLv:12 },
      { id:'cs_ku_med',   icon:'💊', name:"",           desc:"",                  cost:25,  type:'consumable' },
      { id:'cs_ku_title', icon:'🏅', name:"",     desc:"",                         cost:15,  type:'title' },
    ]
  },
  // ── 峨眉派 ──
  emei: {
    items: [
      { id:'cs_e_frag',   icon:'📜', name:"",      desc:"",                         cost:30,  type:'manual', manualId:'m_sw_partial1',   reqLv:12 },
      { id:'cs_e_med',    icon:'💊', name:"",         desc:"",                cost:25,  type:'consumable' },
      { id:'cs_e_title',  icon:'🏅', name:"",       desc:"",                         cost:15,  type:'title' },
    ]
  },
  // ── 唐门 ──
  tangmen: {
    items: [
      { id:'cs_t_frag',   icon:'📜', name:"",          desc:"",             cost:30,  type:'manual', manualId:'m_sh_partial1',   reqLv:16 },
      { id:'cs_t_compl',  icon:'📖', name:"",       desc:"",                         cost:80,  type:'manual', manualId:'m_sh_complete1',  reqLv:28 },
      { id:'cs_t_med',    icon:'💊', name:"",         desc:"",               cost:25,  type:'consumable' },
      { id:'cs_t_title',  icon:'🏅', name:"",       desc:"",                           cost:15,  type:'title' },
    ]
  },
  // ── 其他中小门派通用 ──
  tiandibang: {
    items: [
      { id:'cs_td_med',   icon:'💊', name:"",         desc:"",             cost:25,  type:'consumable' },
      { id:'cs_td_title', icon:'🏅', name:"",        desc:"",                              cost:15,  type:'title' },
    ]
  },
  taohuadao: {
    items: [
      { id:'cs_th_med',   icon:'🍶', name:"",             desc:"",              cost:25,  type:'consumable' },
      { id:'cs_th_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  xuegu: {
    items: [
      { id:'cs_xg_med',   icon:'💊', name:"",             desc:"",                cost:25,  type:'consumable' },
      { id:'cs_xg_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  xuanming: {
    items: [
      { id:'cs_xm_med',   icon:'💊', name:"",         desc:"",             cost:25,  type:'consumable' },
      { id:'cs_xm_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  tianshan: {
    items: [
      { id:'cs_ts_frag',  icon:'📜', name:"",       desc:"",                      cost:80,  type:'manual', manualId:'m_ic_complete1',  reqLv:27 },
      { id:'cs_ts_med',   icon:'🌸', name:"",           desc:"",                   cost:25,  type:'consumable' },
      { id:'cs_ts_title',  icon:'🏅', name:"",        desc:"",                              cost:15,  type:'title' },
    ]
  },
  nangong: {
    items: [
      { id:'cs_ng_med',   icon:'💊', name:"",         desc:"",                  cost:25,  type:'consumable' },
      { id:'cs_ng_title', icon:'🏅', name:"",      desc:"",                            cost:15,  type:'title' },
    ]
  },
  lingxiao: {
    items: [
      { id:'cs_lx_med',   icon:'📜', name:"",           desc:"",          cost:25,  type:'consumable' },
      { id:'cs_lx_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  guigu: {
    items: [
      { id:'cs_gg_med',   icon:'📜', name:"",           desc:"",                cost:25,  type:'consumable' },
      { id:'cs_gg_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  haisha: {
    items: [
      { id:'cs_hs_med',   icon:'💊', name:"",          desc:"",                    cost:25,  type:'consumable' },
      { id:'cs_hs_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  shengguang: {
    items: [
      { id:'cs_sg_med',   icon:'💊', name:"",         desc:"",                  cost:25,  type:'consumable' },
      { id:'cs_sg_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  diancang: {
    items: [
      { id:'cs_dc_frag',  icon:'📜', name:"",       desc:"",                      cost:30,  type:'manual', manualId:'m_po_partial1',   reqLv:17 },
      { id:'cs_dc_med',   icon:'💊', name:"",         desc:"",                               cost:25,  type:'consumable' },
      { id:'cs_dc_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  qingcheng: {
    items: [
      { id:'cs_qc_med',   icon:'💊', name:"",         desc:"",                  cost:25,  type:'consumable' },
      { id:'cs_qc_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
  xixia: {
    items: [
      { id:'cs_xx_med',   icon:'💊', name:"",          desc:"",               cost:25,  type:'consumable' },
      { id:'cs_xx_title', icon:'🏅', name:"",       desc:"",                            cost:15,  type:'title' },
    ]
  },
  tianlong: {
    items: [
      { id:'cs_tl_med',   icon:'💊', name:"",         desc:"",       cost:25,  type:'consumable' },
      { id:'cs_tl_title', icon:'🏅', name:"",         desc:"",                              cost:15,  type:'title' },
    ]
  },
};
...
// ════════════════════════════════════════════════════════════
//  中文语言合并（lang-zh-sects.js 加载后执行）
// ════════════════════════════════════════════════════════════
(function(){
  function doMerge() {
    if (typeof LANG_ZH !== 'undefined' && LANG_ZH.sects && SECTS && SECTS.length) {
      SECTS.forEach(function(s) {
        if (LANG_ZH.sects[s.id]) Object.assign(s, LANG_ZH.sects[s.id]);
      });
    }
  }
  if (typeof LANG_ZH !== 'undefined' && LANG_ZH.sects) {
    doMerge();
  } else {
    // LANG_ZH 未加载，监听脚本加载事件
    document.addEventListener('LANG_ZH_ready', doMerge);
  }
})();

// ════════════════════════════════════════════════════════════
//  门派商店中文合并（lang-zh-sects2.js 加载后执行）
// ════════════════════════════════════════════════════════════
(function(){
  function doMerge() {
    if (typeof LANG_ZH !== 'undefined' && LANG_ZH.sectShop && typeof SECT_CONTRIB_SHOP !== 'undefined' && SECT_CONTRIB_SHOP) {
      for (var sid in SECT_CONTRIB_SHOP) {
        var shop = SECT_CONTRIB_SHOP[sid];
        if (shop && shop.items) {
          shop.items.forEach(function(item) {
            if (LANG_ZH.sectShop[item.id]) Object.assign(item, LANG_ZH.sectShop[item.id]);
          });
        }
      }
    }
  }
  if (typeof LANG_ZH !== 'undefined' && LANG_ZH.sectShop) {
    doMerge();
  } else {
    document.addEventListener('LANG_ZH_ready', doMerge);
  }
